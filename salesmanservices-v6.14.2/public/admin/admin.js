...
function renderDashboard() {
  ...
  panel.innerHTML = `
    <div class="toolbar"><div><span class="eyebrow">Salesman Services V6.14.2</span><h1>Overview</h1><p class="muted">One control room for the live website, stock and operations.</p></div><span class="pill ${syncNeedsAttention ? "warning" : "success"}">${healthText}</span></div>
