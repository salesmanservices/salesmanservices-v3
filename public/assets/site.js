...
function renderAccounts(){
 ...
 <article class="account-card">
  ...
  <div class="account-info">
   ...
   <a class="button primary" href="${accountActionHref(a)}" ${isDiscordOnly(a) ? `target="_blank" rel="noopener"` : ""}>${accountActionLabel(a)}</a>
  </div>
 </article>`).join("");
...
(async()=>{await loadManagedSiteData();buildAccounts();renderSoldAccounts();buildSkill();buildQuests();buildMinigames();buildCapes()})();
