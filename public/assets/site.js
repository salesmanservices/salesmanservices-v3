...
function renderAccounts(){
 ...
 <article class="account-card">
  ...
  <div class="account-info">
   ...
   <a class="button primary" href="${a.type === "Skiller" ? "https://discord.gg/xDSvKT3ThQ" : `/checkout?account=${encodeURIComponent(a.id)}`}" ${a.type === "Skiller" ? `target="_blank" rel="noopener"` : ""}>${a.type === "Skiller" ? "Contact on Discord" : "Buy with BTC / LTC"}</a>
  </div>
 </article>`).join("");
