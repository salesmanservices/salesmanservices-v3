...
function renderContent() {
  ...
  const update = () => {
    ...
    data.settings = { ...data.settings, discord: document.querySelector("#discord").value, sellapp: document.querySelector("#sellapp").value, sythe: document.querySelector("#sythe").value, googleSheetIds: document.querySelector("#sheetIds").value.split(/\n|,/).map((value) => value.trim()).filter(Boolean), googleSheetTabs: document.querySelector("#sheetTabs").value.split(/\n|,/).map((value) => value.trim()).filter(Boolean) };
  };
